...
public class factsB extends PApplet {
...
public void setup() {
  ...
  stringList.add("Einstein couldn't speak fluently when he was nine. His parents thought he might be retarded.");
...
public void newRandChar(){
  randChar = charList.get((int)random(0, charList.size()));
}
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "factsB" };
    if (passedArgs != null) {
